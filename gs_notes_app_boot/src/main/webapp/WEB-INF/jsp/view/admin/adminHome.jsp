...
<div class="d-flex "> 
	<a href="http://localhost:8080/admin/test" class="btn justify-center btn-outline-primary p-2"> verifier les notes de fichier </a>
</div>
<div class="d-flex "> 
	<a href="http://localhost:8080/admin/test" class="btn justify-center btn-outline-primary p-2"> verifier l'annee de Fichier  </a>
</div>
<div class="d-flex "> 
	<a href="http://localhost:8080/admin/test" class="btn justify-center btn-outline-primary p-2"> verifier l'enseignant  </a>
</div>
